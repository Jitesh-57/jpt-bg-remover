...
const FAQS = [
  ...
  { q: "Is it safe to upload my photo to an AI tool?", a: "Use your judgement. Avoid uploading photos containing documents, private surroundings, or other people who haven't agreed to it. Note that some platforms add visible or hidden watermarks to AI-generated images. The free tools on Pixel Shine run in your browser, so images you edit here aren't uploaded to a server." },
