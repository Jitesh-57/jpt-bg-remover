...
export const SEO_POSTS_5: BlogPost[] = [
  ...
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Print needs ~300 DPI, so upscale until your pixels cover the print size — 2× or 4× turns a screen-sized photo into a sharp print. Do it free at Pixel Shine. Upscale for Print Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Line art lives or dies on crisp edges — AI upscaling keeps anime and cartoon lines sharp and colours flat as it enlarges, ideal for wallpapers, avatars and prints. Do it free at Pixel Shine. Upscale Anime Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Low-res and soft photos are very fixable — AI upscaling rebuilds real detail rather than faking sharpness. Start from the best copy and enlarge 2×–4×, free at Pixel Shine. Fix Blur Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `High-res product photos unlock zoom and convert better — upscale to clear your platform's minimum, then compress lightly for speed. Free at Pixel Shine. Upscale Product Photo →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Increasing resolution the right way adds real detail, not just size — AI upscaling reaches 2×–4× while staying sharp. Match the result to the job and start from a clean source. Free at Pixel Shine. Increase Resolution Free →` },
    ],
  ),
  ...
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `To hit 50KB, resize and crop first, then set the 50KB target — that keeps a tight image usable. Free at Pixel Shine. Compress Image Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "How to compress to 500KB (free)", body: `**Step 1 — Open the compressor** at Pixel Shine.\n\n**Step 2 — Upload your image.**\n\n**Step 3 — Set the target to 500KB.** The tool tunes quality to land just under it.\n\n**Step 4 — Download** the result.\n\nNo watermark, no sign-up.` },
      ...
      { heading: "Key takeaways", body: `500KB keeps photos sharp while meeting most limits — set the target and download, no guessing. Free at Pixel Shine. Compress Image Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Compress a PNG to keep transparency and crisp edges — but for photographic PNGs, converting to JPG or WebP saves far more. Free at Pixel Shine. Compress PNG Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Resize to display size, then compress (WebP where possible) to cut image weight 80–90% and speed up your site. Free at Pixel Shine. Compress for Web Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Reduce a JPEG by lowering quality and, for oversized photos, resizing first — big savings, no visible loss. Free at Pixel Shine. Compress JPEG Free →` },
    ],
  ),
  ...
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `JPEG and JPG are the same format — two names from old extension limits, zero quality difference. Convert other formats to JPG free at Pixel Shine. Convert Image Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Convert WebP to JPG when a file won't open or upload — JPG works everywhere; pick PNG only to keep transparency. Free at Pixel Shine. Convert Image Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `BMP is huge because it's uncompressed — convert to JPG to shrink it dramatically with no visible loss (or PNG for lossless). Free at Pixel Shine. Convert Image Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Convert a GIF to PNG for a sharper still with full colour and clean transparency — just remember PNG is a single frame, not animation. Free at Pixel Shine. Convert Image Free →` },
    ],
  ),
  P(
    ...
    [
      ...
      { heading: "Key takeaways", body: `Convert TIFF to JPG for a small, shareable, universally-supported photo — and keep the TIFF as your lossless archive master. Free at Pixel Shine. Convert Image Free →` },
    ],
  ),
];
