...
export const SEO_POSTS_2: BlogPost[] = [
  P(
    ...
    "How to Convert JPG to PNG — Free Online | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ["How do I convert JPG to PNG for free?", "Upload your JPG to Pixel Shine's converter, choose PNG, and download. Free, no watermark, no sign-up."],
      ...
      { heading: "Key takeaways", body: `Convert JPG to PNG when you need a lossless editing master, transparency support, or crisp edges — not just to share a photo (that keeps JPG smaller). It's a one-click, free job at Pixel Shine. Convert Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "How to Compress a JPEG to 200KB — Free | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ["How do I compress a JPEG to exactly 200KB?", "Upload it to Pixel Shine's compressor, set the target to 200KB, and download. It automatically adjusts quality (and dimensions if needed) to fit under 200KB."],
      ...
      { heading: "Key takeaways", body: `200KB is the ideal target for fast, sharp web images. Set the target and let the tool hit it automatically — start from the original and right-size huge images first. Free at Pixel Shine. Compress Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "How to Rotate or Flip an Image — Free Online | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ["How do I rotate an image for free?", "Open Pixel Shine's Rotate & Flip tool, upload your image, choose the rotation, and download. Free, no watermark, no sign-up."],
      ...
      { heading: "Key takeaways", body: `Rotating and flipping fixes orientation in one click, and a clean 90°/180° rotation is fully lossless. Rotate to fix sideways/upside-down images, flip to mirror them. Free at Pixel Shine. Rotate & Flip Free →` },
    ],
  ),
  ...
  P(
    ...
    "SVG to PNG — Convert Vector to Raster Free | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ["How do I convert SVG to PNG for free?", "Upload your SVG to Pixel Shine's converter, choose PNG, and download. Free, no watermark, transparency preserved."],
      ...
      { heading: "Key takeaways", body: `Convert SVG to PNG when an app or platform won't accept vectors — you get a universally-supported, transparent raster image. Export at a large size, keep the SVG master, and re-export as needed. Free at Pixel Shine. Convert Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "Passport Photo Size Guide + How to Crop | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ...
        ["How do I crop a photo to passport shape for free?", "Use Pixel Shine's crop tool — pick 1:1 for square (2×2 inch) styles or a portrait crop for 35×45 mm — with your face centred, then download."],
      ...
      { heading: "Key takeaways", body: `Passport photos follow strict size and framing rules that vary by country. At home you control the shape and framing: shoot front-facing against a plain wall, leave headroom, and crop to 1:1 (square) or a portrait ratio with the face centred. Always verify the official spec. Crop free at Pixel Shine. Crop Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "How to Optimize Images for a Website — Free Guide | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ...
        ["Is it free to optimize images?", "Yes — Pixel Shine's compress and convert tools are free with no watermark or sign-up."],
      ]) },
      { heading: "Key takeaways", body: `Optimise images in three steps: right-size the dimensions, pick an efficient format (WebP for photos), then compress to a sensible target. It's the biggest, easiest speed and SEO win for most sites — and it's free at Pixel Shine. Compress Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "Image File Formats Explained — JPG, PNG, WebP & More | Pixel Shine",
    ...
    [
      ...
      { heading: "How to convert between formats (free)", body: `Whenever you have the wrong format, converting is instant: open Pixel Shine's converter at Pixel Shine, upload your image, choose the output (JPG, PNG or WebP), and download. No watermark, no sign-up, private in your browser. Popular one-click routes: PNG → JPG, WebP → JPG, JPG → WebP, SVG → PNG, GIF → PNG, and more.` },
      { heading: "Frequently asked questions", body: FAQ([
        ...
        ["Can I convert between all these formats?", "You can convert to JPG, PNG or WebP from common inputs (including SVG, GIF, AVIF, BMP) free at Pixel Shine."],
        ["Why won't my WebP/AVIF file open?", "Some older software doesn't support them. Convert to JPG or PNG and it'll open anywhere."],
      ]) },
      { heading: "Key takeaways", body: `Each format has a job: JPG for photos, PNG for graphics/transparency, WebP/AVIF for fast web images, GIF for simple animation, SVG for scalable logos. When you have the wrong one, convert free in seconds at Pixel Shine. Convert Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "How to Make a Profile Picture — Perfect Size & Crop | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ...
        ["How do I crop a profile picture for free?", "Use Pixel Shine's crop tool — pick 1:1 for square or circle for a round image — with your face centred, then download."],
      ...
      { heading: "Key takeaways", body: `A great profile picture is your face, centred and well-lit, cropped tight to a square (or circle) from a high-res source. Crop to 1:1 or circle for free at Pixel Shine — and upscale first if the source is small. Crop Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "How to Compress a PNG Without Losing Quality — Free | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ["How do I compress a PNG without losing quality?", "Compress it to a target size with Pixel Shine's compressor. For photo-content PNGs that don't need transparency, converting to JPG or WebP shrinks them far more with no visible loss."],
      ...
      { heading: "Key takeaways", body: `Compress a PNG by trimming it to a target size — or, if it's really a photo without transparency, convert it to JPG/WebP for a dramatically smaller file. Keep PNG or WebP when transparency matters. Free at Pixel Shine. Compress Image Free →` },
    ],
  ),
  ...
  P(
    ...
    "YouTube Thumbnail Size (2026) + How to Crop | Pixel Shine",
    ...
    [
      ...
      { heading: "Frequently asked questions", body: FAQ([
        ...
        ["How do I crop an image to 16:9 for free?", "Use Pixel Shine's crop tool, choose the 16:9 ratio, centre your subject, and download. No watermark."],
      ...
      { heading: "Key takeaways", body: `A great YouTube thumbnail is 16:9 (1280×720), with a clear focal point, big readable text, and high contrast. Crop to 16:9 first so nothing gets cut, and upscale if it's soft. Free at Pixel Shine. Crop Image Free →` },
    ],
  ),
];
