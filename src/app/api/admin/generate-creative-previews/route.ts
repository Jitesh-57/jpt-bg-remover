...
const BEFORE_SUBJECT: Record<string, string> = {
  "linkedin-banner": "a plain smartphone photo of an office building exterior",
  "christmas-photo": "an ordinary, plainly-lit smartphone selfie of a young adult in a t-shirt against a blank wall",
  "baby-photoshoot": "an ordinary, plainly-lit smartphone photo of a baby on a plain blanket",
  "graduation-photo": "an ordinary, plainly-lit smartphone selfie of a young adult in casual clothes against a blank wall",
  "gym-transformation": "an ordinary, plainly-lit smartphone selfie of a person in casual clothes against a blank wall",
  "ghibli-style": "an ordinary, plainly-lit smartphone selfie of a young adult outdoors",
  "y2k-aesthetic": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "wedding-invite-photo": "an ordinary, plainly-lit smartphone selfie of a couple in casual clothes against a blank wall",
  "corporate-avatar": "an ordinary, plainly-lit smartphone selfie of a person in casual clothes against a blank wall",
  "old-money-aesthetic": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "barbie-box": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "ai-baby-predictor": "an ordinary, plainly-lit smartphone selfie of a young couple against a blank wall",
  "lego-minifigure": "an ordinary, plainly-lit smartphone selfie of a young adult in colourful casual clothes against a blank wall",
  "pixar-avatar": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "renaissance-portrait": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "age-progression": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "superhero-costume": "an ordinary, plainly-lit smartphone selfie of a young adult standing against a blank wall",
  "tarot-card-portrait": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "90s-yearbook-photo": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
  "cyberpunk-avatar": "an ordinary, plainly-lit smartphone selfie of a young adult against a blank wall",
};
