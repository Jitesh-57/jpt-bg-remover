...
const IMAGES: Record<string, { src: string; dest: string }> = {
  ...
  // Per-tool landing page showcase images
  "page-remove-bg":  { src: `${PB}/t.resize(w:1200)~t.compress(q:80)/landing/remove-bg-page/result_0.png`,  dest: "page-remove-bg.png" },
  "page-upscale":    { src: `${PB}/t.resize(w:1200)~t.compress(q:80)/landing/upscale-page/result_0.png`,    dest: "page-upscale.png" },
  "page-ai-editor":  { src: `${PB}/t.resize(w:1200)~t.compress(q:80)/landing/ai-editor-page/result_0.png`,  dest: "page-ai-editor.png" },
  "page-ai-headshot":{ src: `${PB}/t.resize(w:1200)~t.compress(q:80)/landing/ai-headshot-page/result_0.png`, dest: "page-ai-headshot.png" },
};
