    ...
    <>
      ...
      <section style={{ background: 'var(--surface)', padding: '56px 24px 72px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: 'clamp(1.5rem,3vw,2rem)', fontWeight: 800, color: 'var(--text)', margin: '0 0 12px', letterSpacing: '-0.02em' }}>Compress to a target size</h2>
          <p style={{ fontSize: 15, color: 'var(--text-muted)', margin: '0 0 28px' }}>Pick an exact file size — free, instant, no watermark.</p>
