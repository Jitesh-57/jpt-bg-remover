...
const CORE_TOOLS = [
  ...
  { icon: "↔️", name: "Resize Image", desc: "Resize to exact pixels", href: "/resize-image" },
  { icon: "🔄", name: "Rotate & Flip", desc: "Turn or mirror photos", href: "/rotate-image" },
  { icon: "🔳", name: "QR Code Generator", desc: "Link or text to QR code", href: "/qr-code-generator" },
  { icon: "🫥", name: "Blur Image", desc: "Hide faces & sensitive info", href: "/blur-image" },
