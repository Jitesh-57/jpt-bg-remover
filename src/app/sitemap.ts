...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const freePages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/resize-image`,     lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/rotate-image`,     lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/qr-code-generator`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/blur-image`,       lastModified: now, changeFrequency: "monthly", priority: 0.9 },
