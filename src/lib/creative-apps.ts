...
export const CREATIVE_APPS: CreativeApp[] = [
  ...
  },
  {
    ...
    intro: "Turn your photo into a boxed Funko Pop-style collectible.",
    prompt: "Turn this person into a Funko Pop-style vinyl collectible figure: oversized rounded head, small black dot eyes, simplified blocky body matching their real outfit and hair colour, standing in a printed collector's box with a clear plastic window, studio product-photography lighting. Keep the likeness recognisable in toy form. This must look like a real photograph of a physical vinyl toy in its retail box — sharp studio product-photography detail and realistic plastic material — not a flat illustration or cartoon drawing.",
    badge: "✨ Funko Pop",
    faq: [
  ...
  },
  {
    ...
    intro: "Turn a selfie into a stop-motion claymation character.",
    prompt: "Convert this photo into a claymation stop-motion character: visible clay texture with soft fingerprint-like imperfections, slightly exaggerated rounded features, matte studio lighting like a stop-motion film set, and a miniature handcrafted set-style background. Keep the person's likeness recognisable in clay form.",
    badge: "✨ Claymation",
    faq: [
  ...
  },
  {
    ...
    intro: "Turn your photo into a bold comic book cover illustration.",
    prompt: "Convert this photo into a bold comic book cover illustration: thick ink outlines, dramatic halftone shading, vivid primary colours, a dynamic action pose, an oversized stylised title-logo area at the top, and a classic superhero-comic composition. Keep the person's likeness recognisable in illustrated form.",
    badge: "✨ Comic Cover",
    faq: [
  ...
  },
  {
    ...
    intro: "Get the viral coastal cowgirl aesthetic from one selfie.",
    prompt: "Restyle this photo with a coastal cowgirl aesthetic: a straw cowboy hat, light denim and white linen, subtle western-style boots or accessories, sun-bleached beachy hair, warm golden-hour coastal lighting and a breezy ocean-adjacent backdrop. Keep the person's face and identity exactly the same. This must look like a real photograph — natural skin texture, realistic lighting and shadows, sharp photographic detail — not a painting, illustration, or cartoon.",
  ...
  },
  {
    ...
    intro: "Get a classic old Hollywood red-carpet glamour portrait.",
    prompt: "Transform this photo into a classic old Hollywood glamour portrait: elegant 1950s-style formalwear, dramatic studio key lighting with soft falloff, glossy finger-waved hair styling, rich black-and-white or sepia tone, and a red-carpet studio backdrop. Keep the person's face and identity exactly the same. This must look like a real photograph — natural skin texture, realistic lighting and shadows, sharp photographic detail — not a painting, illustration, or cartoon.",
    badge: "✨ Old Hollywood",
    faq: [
  ...
  },
  {
    ...
    intro: "Get a glam, formal prom-night portrait from a selfie.",
    prompt: "Transform this photo into a glamorous prom-night portrait: elegant formalwear, soft romantic studio lighting with gentle sparkle bokeh, polished hair and makeup styling, and a festive formal-event backdrop. Keep the person's face and identity exactly the same. This must look like a real photograph — natural skin texture, realistic lighting and shadows, sharp photographic detail — not a painting, illustration, or cartoon.",
    badge: "✨ Prom Glam",
    faq: [
  ...
  },
  {
    ...
    intro: "Get a cozy, warm fall Thanksgiving-style portrait.",
    prompt: "Transform this photo into a cozy Thanksgiving fall portrait: warm autumn-toned knitwear, soft golden hour light, a backdrop of fall foliage or a rustic dinner table with pumpkins and candles, and a warm festive family-gathering mood. Keep the person's face and identity exactly the same. This must look like a real photograph — natural skin texture, realistic lighting and shadows, sharp photographic detail — not a painting, illustration, or cartoon.",
    badge: "✨ Fall Portrait",
    faq: [
  ...
  },
  {
    ...
    intro: "Get the viral AI glow-up — polished skin, light and styling.",
    prompt: "Give this photo a natural glow-up enhancement: smoother even skin texture without losing realism, brighter and more flattering studio-quality lighting, subtly improved hair styling, and a polished, well-rested look. Keep the person's face, identity and features exactly the same — this is an enhancement, not a different person. This must look like a real photograph — natural skin texture, realistic lighting and shadows, sharp photographic detail — not a painting, illustration, or cartoon.",
    badge: "✨ Glow Up",
    faq: [
  ...
  },
  {
    ...
    intro: "Turn a selfie into a dramatic astronaut space portrait.",
    prompt: "Transform this person into an astronaut: a detailed realistic space suit with a reflective helmet visor, dramatic rim lighting, and a backdrop of stars, Earth, or a spacecraft interior. Keep the person's face and identity exactly the same. This must look like a real photograph — natural skin texture, realistic lighting and shadows, sharp photographic detail — not a painting, illustration, or cartoon.",
    badge: "✨ Astronaut",
    faq: [
  ...
  },
  {
    ...
    intro: "Turn a selfie into a retro 8-bit pixel art avatar.",
    prompt: "Convert this photo into a retro 8-bit pixel art character portrait: visible square pixel blocks, a limited retro video-game colour palette, simplified blocky facial features, and a flat solid-colour background like a classic arcade character-select screen. Keep the person's likeness recognisable in pixel form.",
    badge: "✨ Pixel Art",
    faq: [
...
export const CREATIVE_CONTENT: Record<string, CreativeContent> = {
  ...
  "funko-pop-figure": {
    ...
    tips: [
      "A clear, front-facing or upper-body photo works best — the figure needs your hair and outfit visible.",
      "Bold, distinct clothing colours translate into a more recognisable vinyl figure.",
      "A plain background helps the AI separate you cleanly from the scene.",
      "Try the 3D Figurine Maker and Lego Minifigure Maker too for different collectible styles.",
    ],
  },
  "claymation-portrait": {
    paragraphs: [
      "Claymation has a charm that smooth digital renders don't — the slightly imperfect, handmade texture is what makes stop-motion films feel warm and tactile. This brings that same look to an ordinary photo.",
      "Upload a selfie and the AI gives you visible clay texture, gently exaggerated rounded features and that matte, miniature-set lighting stop-motion films are known for. Your likeness stays recognisable; it's the material and styling that change.",
      "It's a fun alternative to generic cartoon filters for anyone searching 'claymation filter free' or 'stop motion clay portrait ai' — a distinctive look for profile pictures, fan art, or just seeing yourself rendered like a character from a clay-animated film.",
    ],
    tipsTitle: "Tips for the best claymation result",
    tips: [
      "A clear, front-facing photo with simple lighting gives the cleanest clay texture.",
      "Simple backgrounds help the AI build a convincing miniature-set backdrop.",
      "Re-run it a couple of times — the clay texture and set details vary each generation.",
      "Works well on pets and group photos too, not just solo portraits.",
    ],
  },
  "comic-book-cover": {
    paragraphs: [
      "Everyone's pictured themselves as the hero of their own comic at some point — bold ink lines, dramatic colour, an action pose on the cover. This makes that happen from a regular photo.",
      "Upload a photo and the AI illustrates you with thick ink outlines, halftone shading and vivid comic-style colour, composed like a real superhero comic cover with space for a title logo. It's a striking, shareable transformation, not a subtle filter.",
      "It's a popular pick for anyone searching 'turn photo into comic ai' or 'superhero comic portrait free' — works great as a poster, a profile picture, or paired with our AI Superhero Costume Maker for a matching set.",
    ],
    tipsTitle: "Tips for the boldest comic cover",
    tips: [
      "A clear photo with a confident, visible pose makes for the most dynamic cover.",
      "Simple backgrounds let the AI build a cleaner comic-style composition around you.",
      "Try it alongside the Superhero Costume Maker for a matching hero look.",
      "Re-run it a few times — the colour palette and action pose vary each generation.",
    ],
  },
  "coastal-cowgirl": {
    paragraphs: [
      "Coastal cowgirl — denim, straw hats and beachy waves under golden light — has been one of the biggest aesthetic trends on US social feeds, and it's a look most people don't actually own the wardrobe for. This styles it on a photo you already have.",
      "Upload a selfie and the AI adds the hat, the denim-and-linen styling and that warm, sun-bleached coastal lighting, while keeping your face exactly the same. It reads as a real, styled photoshoot, not an obvious filter.",
      "If you've seen 'coastal cowgirl aesthetic' trending and wanted in without a shopping trip, this is built for exactly that — a quick, free way to try the look for a profile picture, a moodboard, or just for fun.",
    ],
    tipsTitle: "Tips for the best coastal cowgirl look",
    tips: [
      "A clear, well-lit selfie with your face and shoulders visible works best.",
      "Outdoor or naturally lit photos blend most convincingly with the golden-hour styling.",
      "Re-run it a couple of times — the styling details vary each generation.",
      "Try the Old Money Aesthetic and Y2K Aesthetic apps too for other trending styles.",
    ],
  },
  "old-hollywood-glamour": {
    paragraphs: [
      "There's a timeless quality to old Hollywood glamour shots — dramatic studio lighting, glossy waved hair, that rich black-and-white finish. It's a style that usually needs a real studio session to pull off.",
      "Upload a selfie and the AI restyles it with classic 1950s-style formalwear, dramatic key lighting and that glossy vintage finish, while your face stays exactly the same. The result reads like a real archival studio portrait, not a generic filter.",
      "It's a favourite for anyone searching 'old hollywood glamour ai' or 'vintage red carpet photo ai' wanting a timeless, elegant portrait for a profile picture, an anniversary post, or just to see themselves in a classic cinematic light.",
    ],
    tipsTitle: "Tips for the most authentic glamour portrait",
    tips: [
      "A clear, front-facing photo with simple, even lighting works best.",
      "Plain backgrounds help the AI build a clean studio-style composition.",
      "Re-run it a few times — the lighting and styling vary slightly each generation.",
      "Pair it with the Renaissance Portrait or Tarot Card Portrait apps for more classic art styles.",
    ],
  },
  "prom-photoshoot": {
    paragraphs: [
      "Prom photos are supposed to be the polished, dressed-up version of you — but between a packed schedule and a rushed group photo, the real moment doesn't always get captured well. This gives you that glam portrait separately, any time.",
      "Upload a selfie and the AI styles a formal prom-night look: elegant formalwear, soft romantic lighting with a touch of sparkle, and polished hair and makeup — all while keeping your face exactly the same.",
      "It's a popular pick for anyone searching 'ai prom photo maker' or 'prom photoshoot generator free' wanting a glam portrait for invitations, save-the-dates, or just a backup shot that actually looks the way the night felt.",
    ],
    tipsTitle: "Tips for the most polished prom photo",
    tips: [
      "A clear, front-facing photo with good lighting works best.",
      "Simple backgrounds help the AI build a clean formal-event composition.",
      "Re-run it a couple of times — the styling and lighting vary each generation.",
      "Try it with a friend or date's photo too for a matching prom-night set.",
    ],
  },
  "thanksgiving-photoshoot": {
    paragraphs: [
      "Thanksgiving is the one holiday built around gathering, and everyone wants a cozy, warm photo to mark it — but between cooking and guests, an actual photoshoot rarely happens. This creates that warm fall portrait from a photo you already have.",
      "Upload a selfie and the AI adds cozy autumn-toned knitwear, soft golden hour light and a warm fall backdrop — foliage, a rustic table, candles — while your face stays exactly the same.",
      "It's a popular pick for anyone searching 'ai thanksgiving photo maker' or 'friendsgiving photo generator' wanting a quick, cozy seasonal portrait for holiday cards, group chats, or a festive profile picture update.",
    ],
    tipsTitle: "Tips for the coziest fall portrait",
    tips: [
      "A clear, front-facing photo with warm or neutral lighting works best.",
      "Simple backgrounds let the AI build the fall scenery around you cleanly.",
      "Run it on a few family members separately for a matching cozy holiday set.",
      "Re-run it a couple of times — the autumn styling varies each generation.",
    ],
  },
  "glow-up-filter": {
    paragraphs: [
      "The 'AI glow up' trend is everywhere right now — people sharing a before/after where they just look... better lit, better rested, more polished, without looking like a different person. This is built to do exactly that, not a face swap.",
      "Upload a selfie and the AI smooths skin texture naturally, brightens and improves the lighting, and tidies up styling — while keeping your actual face, features and identity exactly the same. It's an enhancement, not a transformation.",
      "If you've searched 'ai glow up filter' or 'instant glow up online,' this is the free version of that viral trend — useful for a refreshed profile picture, a confidence boost before a big post, or just seeing your best-lit self.",
    ],
    tipsTitle: "Tips for the most natural glow up",
    tips: [
      "A clear, well-lit selfie gives the AI the cleanest base to enhance.",
      "Avoid heavy filters on the original photo — the AI works best on an unedited shot.",
      "Re-run it if the first result feels too subtle or too strong — each pass varies slightly.",
      "Pair it with the AI Professional Headshot Maker for a polished profile-picture set.",
    ],
  },
  "astronaut-photoshoot": {
    paragraphs: [
      "There's something universally fun about seeing yourself as an astronaut — it's the kind of photo that gets saved and shared. Renting a real space suit obviously isn't an option, so this builds the look around your photo instead.",
      "Upload a selfie and the AI suits you up in a detailed, realistic space suit with a reflective helmet visor, dramatic rim lighting and a backdrop of stars, Earth, or a spacecraft interior — while your face stays exactly the same.",
      "It's a popular pick for anyone searching 'ai astronaut photo maker' or 'space suit photo ai free' — a novelty portrait for kids' rooms, space-themed parties, school projects, or just a fun profile picture upgrade.",
    ],
    tipsTitle: "Tips for the most dramatic astronaut portrait",
    tips: [
      "A clear, front-facing photo with your face and shoulders visible works best.",
      "Simple backgrounds help the AI build the space scene around you cleanly.",
      "Re-run it a couple of times — the backdrop (stars, Earth, spacecraft) varies each generation.",
      "Works great for kids' photos too — a popular space-themed birthday or bedroom print.",
    ],
  },
  "pixel-art-avatar": {
    paragraphs: [
      "Pixel art has stayed a favourite in gaming culture for decades — there's something nostalgic and instantly recognisable about an 8-bit character. This turns your actual photo into one.",
      "Upload a selfie and the AI converts it into a retro pixel-art character: visible square pixel blocks, a limited retro game colour palette, and a flat arcade-style background — like a character-select screen from a classic console game.",
      "It's a popular pick for anyone searching 'ai pixel art avatar maker' or 'photo to pixel art online' wanting a distinctive gaming profile picture for Discord, Steam, Twitch, or a retro-styled forum avatar.",
    ],
    tipsTitle: "Tips for the cleanest pixel art avatar",
    tips: [
      "A clear, front-facing photo with simple lighting gives the cleanest pixel conversion.",
      "Bold, distinct hair and clothing colours translate best into a limited pixel palette.",
      "A plain background helps the AI build a clean arcade-style backdrop.",
      "Use it as a matching avatar across Discord, Steam, and Twitch for a consistent retro look.",
    ],
  },
};
