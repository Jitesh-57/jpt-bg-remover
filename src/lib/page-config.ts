...
export const DEFAULT_CONFIGS: Record<string, PageSEO> = {
  ...
  'compress-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Instant & Online', desc: 'Everything runs on your device — nothing is uploaded to a server' },
  ...
  'convert-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Online & Private', desc: 'Conversion happens on your device — nothing is uploaded' },
    ...
    faq: [
      ...
      { q: 'Is my image uploaded anywhere?', a: 'No. The converter runs entirely online, so your file stays private on your device.' },
  ...
  'crop-image': {
    ...
    faq: [
      ...
      { q: 'Is my image uploaded to a server?', a: 'No. Cropping runs online, so your photo stays private on your device.' },
  ...
  'rotate-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Online & Private', desc: 'Runs on your device — nothing is uploaded to a server' },
    ...
    faq: [
      ...
      { q: 'Is my image uploaded anywhere?', a: 'No. Everything runs online, so your photo stays private on your device.' },
  ...
  'image-to-pdf': {
    ...
    faq: [
      ...
      { q: 'Is my image uploaded to a server?', a: 'No. The PDF is built entirely online, so your file stays private on your device.' },
