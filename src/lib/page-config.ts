...
export const DEFAULT_CONFIGS: Record<string, PageSEO> = {
  ...
  home: {
    ...
    features: [
      ...
      { icon: '🧰', title: 'A dozen free tools', desc: 'Compress, convert, crop, resize, rotate, blur, watermark and more — free and unlimited, with no account needed.' },
    ...
    faq: [
      { q: 'Is Pixel Shine free?', a: 'The free tools — compress, convert, crop, resize, rotate, blur, watermark, meme text, image to PDF, QR codes and normal upscaling — are free and unlimited with no account. The AI features use credits, bought once from $2.' },
      ...
      { q: 'Are my uploads private?', a: 'Images you edit with the free tools are never stored or shared. The AI features do send the image to a server to generate the result, and it is not shared with third parties.' },
    ],
  },
  ...
  'compress-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Instant & Online', desc: 'Instant results, and nothing is stored or shared' },
    ...
    faq: [
      ...
      { q: 'Is my photo uploaded to a server?', a: 'No. Your image is not stored or shared — compression is private and instant.' },
  ...
  'convert-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Online & Private', desc: 'Instant conversion, and nothing is stored or shared' },
    ...
    faq: [
      ...
      { q: 'Is my image uploaded anywhere?', a: 'No. Your file stays private and is never stored or shared.' },
  ...
  'crop-image': {
    ...
    faq: [
      ...
      { q: 'Is my image uploaded to a server?', a: 'No. Your photo stays private and is never stored or shared.' },
      { q: 'Is there a watermark or limit?', a: 'No watermark and no limits — crop as many images as you like for free.' },
      { q: 'Do I need to install anything?', a: 'No. It runs online — no app or software needed.' },
    ],
  },
  'rotate-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Online & Private', desc: 'Instant results, and nothing is stored or shared' },
    ...
    faq: [
      ...
      { q: 'Is my image uploaded anywhere?', a: 'No. Your photo stays private and is never stored or shared.' },
  ...
  'image-to-pdf': {
    ...
    subtitle:
      'Turn any photo into a PDF in one click — free online. Great for documents, forms, and sharing. No watermark, no sign-up, private online conversion.',
    ...
    faq: [
      ...
      { q: 'Is my image uploaded to a server?', a: 'No. Your file stays private and is never stored or shared.' },
      ...
      { q: 'Do I need to install anything?', a: 'No. It works online — no app, no Acrobat, no software required.' },
    ],
  },
  'watermark-image': {
    ...
    faq: [
      ...
      { q: 'Is my photo uploaded to a server?', a: 'No. Your image stays private and is never stored or shared.' },
  ...
  'meme-generator': {
    ...
    faq: [
      ...
      { q: 'Is my image uploaded to a server?', a: 'No. The meme is made entirely online, so your image stays private.' },
      { q: 'Do I need to install anything?', a: 'No. It works online — no app or software required.' },
    ],
  },
  'resize-image': {
    ...
    features: [
      ...
      { icon: '⚡', title: 'Online & Private', desc: 'Instant resizing, and nothing is stored or shared' },
